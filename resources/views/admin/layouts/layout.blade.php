...
<script src="{{ asset('assets/admin/js/bs-custom-file-input-init.js') }}"></script>
<script src="https://cdn.tiny.cloud/1/3iuuqb3suc9rutqnqby67pvx5gleos10c3f8b4dnx5jjrjty/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
<script>
    tinymce.init({
